                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; overflow:hidden; background:#ffffff; border:1px solid #eee4d7; border-radius:24px; box-shadow:0 24px 64px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:34px 30px 16px;">
                            ...
                            <h1 style="margin:0; color:#111111; font-family:Georgia, 'Times New Roman', serif; font-size:42px; line-height:1.02; font-weight:700;">Reset your password</h1>
                            <p style="margin:22px 0 0; color:#555555; font-size:16px; line-height:1.8;">
                                Hi {{ $userName }}, we received a request to reset the password for your Library BOUGDIM account.
                    ...
                    <tr>
                        <td style="padding:14px 30px 28px;">
                            <a href="{{ $resetUrl }}" style="display:inline-block; background:#1a1a1a; color:#ffffff; text-decoration:none; padding:17px 28px; border-radius:999px; font-size:13px; font-weight:800; letter-spacing:0.4px; text-transform:uppercase; box-shadow:0 14px 30px rgba(26,26,26,0.18);">
                                Create new password
                            </a>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#fbf8f3; border:1px solid #eee4d7; border-radius:18px;">
                                <tr>
                                    <td style="padding:18px;">
                                        <p style="margin:0 0 8px; color:#5f4a31; font-size:13px; font-weight:800;">This link expires in {{ $expiresIn }} minutes.</p>
                                        <p style="margin:0; color:#666666; font-size:14px; line-height:1.7;">
                                            If you did not ask for this reset, you can safely ignore this email. Your password will stay unchanged.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding:0 30px 32px;">
                            <p style="margin:0 0 10px; color:#888888; font-size:12px; line-height:1.7;">If the button does not work, copy and paste this link into your browser:</p>
                            <p style="margin:0; word-break:break-all; color:#1a1a1a; font-size:12px; line-height:1.6;">
